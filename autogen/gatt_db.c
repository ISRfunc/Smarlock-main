...
{
  0xe7, 0x61, 0xb1, 0xf1, 0xc6, 0xe5, 0x67, 0x8c, 0x2f, 0x43, 0x9d, 0x23, 0x45, 0x60, 0x35, 0xb9, 
  0xe2, 0x35, 0x62, 0x36, 0x0e, 0xc8, 0x7d, 0xa8, 0xec, 0x4b, 0xee, 0x07, 0xa2, 0xbe, 0x09, 0x00, 
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_18) = {
  .len = 16,
  .data = { 0xe5, 0x36, 0x69, 0x3b, 0xdc, 0x07, 0xa7, 0x8b, 0x70, 0x4f, 0x81, 0xa6, 0x74, 0x45, 0x09, 0x63, }
};
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_10) = {
  .properties = 0x0a,
  .max_len = 9,
  .data = { 0x53, 0x6d, 0x61, 0x72, 0x74, 0x6c, 0x6f, 0x63, 0x6b, },
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x15, .uuid = 0x8000, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x02, .dynamicdata = &gattdb_attribute_field_20 },
  ...
  { .handle = 0x17, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x0a, .char_uuid = 0x8001 } },
  { .handle = 0x18, .uuid = 0x8001, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
};
